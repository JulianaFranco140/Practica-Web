...
async function POST(request) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].rpc("app_login", {
            p_username: username,
            p_password: password
        });
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0zi~0t5._.js.map